  ...
  return (
    <>
      <header className="flex w-full items-center justify-center lg:h-[50px]">
        <nav className="fixed top-0 z-50 mt-0 h-12 w-full items-center justify-center bg-slate-900 lg:m-auto lg:mx-auto lg:flex lg:h-[50px] lg:w-[1200px] lg:justify-between">
